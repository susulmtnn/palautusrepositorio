...
class ProjectReader:
    ...
    def get_project(self):
        ...
        #print(thisistoml)
        return Project(thisistoml["tool"]["poetry"]["name"], thisistoml["tool"]["poetry"]["description"], thisistoml["tool"]["poetry"]["dependencies"], thisistoml["tool"]["poetry"]["group"]["dev"]["dependencies"])
